...
###$$ GET_TRIAL_BIN_INDICES #####
def get_trial_bin_indices(trialFinalBin, trial_index):
    """
    Function that gets the indices of the bins of a trial

    Parameters
    ----------
    trialFinalBin: array of integers
        the indices of the bins of the trials
    trial_index: integer
        the index of the trial
    """
    if trial_index == 0:
        return 0, trialFinalBin[trial_index]
    else:
        return trialFinalBin[trial_index - 1] + 1, trialFinalBin[trial_index]